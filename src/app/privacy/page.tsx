        ...
        <main>
            <div className='flex flex-column justify-content-center pt-5 m-5'>
                ...
                <p>
                    ...
                    and safeguard your information when you use our Services. By
                ...
                <ul style={LISTOVERRIDE}>
                    <li style={LIST_ITEM}>
                        ...
                        help us provide and maintain the Services.
                    </li>
                    <li style={LIST_ITEM}>
                ...
                <p>
                    ...
                    notify you of any changes by updating the &quot;Effective
                ...
                <p>
                    ...
                    and use of the services provided by XYIAN Software
                    (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; or
                    &quot;our&quot;), including our website and software
                ...
                <p>
                    You agree to use the Services in compliance with these Terms
                    and all applicable laws. You must not:
                </p>
                <ul style={LISTOVERRIDE}>
                    <li style={LIST_ITEM}>
                ...
                <p>
                    If you purchase any Services that we offer for a fee, you
                    agree to pay the applicable fees and taxes. We may suspend
                    or terminate your access to the Services if your payment is
                    late or your account is in arrears.
                </p>

                <h4>5. Intellectual Property</h4>
                <p>
                    All content, trademarks, and logos on the Services are the
                    property of XYIAN Software or its licensors and are
                    protected by intellectual property laws. You may not use our
                    content or marks without our prior written permission.
                </p>

                <h4>6. Termination</h4>
                <p>
                    We may terminate or suspend your access to the Services at
                    any time for any reason, including your breach of thes
                ...
                <p>
                    ...
                    not warrant that the Services will be uninterrupted or
                    error-free.
                </p>

                <h4>8. Limitation of Liability</h4>
                <p>
                    In no event shall XYIAN Software be liable for any indirect,
                    incidental, special, or consequential damages arising out of
                    or related to your use of the Services, even if we have been
                ...
                <p>
                    ...
                    material changes, we will notify you by posting the revised
                    Terms on our website and updating the &quot;Effective
